    ...
    if phase == "train":
        ...
        for epoch in tqdm(range(num_of_epochs)):
            ...
            (
                ...
                dataloader[0], target_dataloader[0], gpu_train, optimizer, net, "train"
            )
            ...
            (
                ...
                dataloader[1], target_dataloader[1],gpu_train, optimizer, net,  "val"
            )
        ...
        (
            ...
            dataloader[0],target_dataloader[0], gpu_train, optimizer, net, "test"
        )
...
def loop_over_all_datapoints(
    dataloader, target_dataloader, gpu_train, optimizer, net,  phase
):
    running_corrects = 0
    running_loss = 0.0
    actual_labels = []
    ...
    for X, y in tqdm(target_dataloader):
        ...
        with torch.set_grad_enabled(phase == "train"):
            ...
            # print("y", y.shape)
            loss_on_target = dist_loss(log_prob_target, y) 
